  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-panel rounded-[2rem] p-6">
        <textarea value={message} onChange={(event) => setMessage(event.target.value)} placeholder="Ask about appointments, doctors, or clinic guidance" className="min-h-40 w-full rounded-2xl border border-slate-200 bg-white p-4 outline-none dark:border-slate-800 dark:bg-slate-950" />
